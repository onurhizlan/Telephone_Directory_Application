...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.maskedinput/1.4.1/jquery.maskedinput.js"></script>
 ...
 <script type="text1/javascript" src="https://code.jquery.com/jquery-3.1.1.min.js"></script>
  <script type="text1/javascript">  
   ...
   <body>
      ...
      <div id="1" class="tabcontent">
		...
		<div id="ara"> 
            First Name:<br>
            <input type="text1" name="ad"><br>
			<div id="sonuc">  
			 </div></div>
			<span>sonuc</span>
			 
            Last Name:<br>
            <input type="text2" name="soyad">	<br>
